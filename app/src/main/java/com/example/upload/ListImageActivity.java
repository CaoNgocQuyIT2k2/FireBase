    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseStorage.getInstance().getReference().child("images").listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                ImageAdapter adapter = new ImageAdapter(ListImageActivity.this, arrayList);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ListImageActivity.this, "Failed to retrieve images", Toast.LENGTH_SHORT).show();
            }
        });
    }
}